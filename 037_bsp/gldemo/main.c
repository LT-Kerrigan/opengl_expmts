...
bool draw_wall(float start_x, float start_y, float end_x, float end_y, int unique_id) {
	...
	switch(unique_id){
		case 0: glUniform3f(colour_loc, 0.8,0,0); break;
		case 1: glUniform3f(colour_loc, 0.8,0,0.5); break;
		case 2: glUniform3f(colour_loc, 0.0,0.8,0); break;
		case 3: glUniform3f(colour_loc, 0.0,0,0.8); break;
		case 4: glUniform3f(colour_loc, 0.8,0.8,0); break;
		case 5: glUniform3f(colour_loc, 0.0,0.8,0.8); break;
		default: glUniform3f(colour_loc, 1,1,1);
	}
...
// test the drawing code
	...
	mat4 V = look_at( (vec3){.x = -1, .y = 30, .z = 30}, (vec3){.x = -1, .y = 0, .z = 0}, (vec3){.x = 0, .y = 0.7, .z = -0.7} );
